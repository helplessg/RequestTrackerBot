            ...
            if key == "_id":
                ...
                if document[key][0] != channelID:
                    ...
                    if data == "rejected":
                        ...
                        return await callback_query.answer(
                            "This request Is Completed 🥳...\nTᴏ Cʜᴇᴄᴋᴏᴜᴛ Tʏᴘᴇ Cᴏʀʀᴇᴄᴛ Mᴏᴠɪᴇ Nᴀᴍᴇ ɪɴ ɢʀᴏᴜᴘ ᴡɪᴛʜ Cᴏʀʀᴇᴄᴛ Sᴘᴇʟʟɪɴɢ 😎",
                            show_alert = True
                        )
                    ...
                    if user.status not in ("administrator", "creator"): # If accepting, rejecting request tried to be done by neither admin nor owner
                        ...
                        if data == "reject":
                            ...
                            result = "COMPLETED"
                            groupResult = "ɪs Cᴏᴍᴘʟᴇᴛᴇᴅ Tʏᴘᴇ Cᴏʀʀᴇᴄᴛ Mᴏᴠɪᴇ Nᴀᴍᴇ ʜᴇʀᴇ ɪɴ ɢʀᴏᴜᴘ ᴡɪᴛʜ Cᴏʀʀᴇᴄᴛ Sᴘᴇʟʟɪɴɢ 😎 & ᴛʜᴀɴᴋ ᴛᴏ ᴀᴅᴍɪɴ 🥳"
